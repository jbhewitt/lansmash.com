...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page">
	...
	<div id="loginbar" class="clear-block"><div>
	<?php print $login; ?></a>
	</div></div>

	<?php if ($node->type == 'forum'): ?>
		<?php $main_fluid = true; ?>
		<div id="page-inner-fluid">
	<?php else: ?>
		<div id="page-inner">
	<?php endif; ?>
...
<?php endif; ?>
	...
	<?php if ($node->type == 'forum'): ?>
		<?php $main_fluid = true; ?>
        	<div id="main-inner-fluid" class="clear-block">	
	<?php else: ?>
...
<?php endif; ?>
  ...
  <?php if ($closure_region): ?>
	...
	<div id="closure-blocks-inner"><?php print $closure_region; ?></div>
    </div>
  <?php endif; ?>
