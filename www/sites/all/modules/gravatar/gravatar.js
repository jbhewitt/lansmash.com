...
Drupal.behaviors.gravatarSettings = function (context) {
  $('input[name=gravatar_default]:not(.gravatarSetting-processed)', context).addClass('gravatarSetting-processed').click(function () {
